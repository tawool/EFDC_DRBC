...
C    MODIFIED BY J.S.(5/5/98)
      IF(ISSKIP .GT. 0) CALL SKIPCOMM(1,CCMRM)
      IF(ISSKIP .EQ. 0) READ(1,999)
      READ(1,*) WQKETSS,WQKECHL,WQCHLC(1),WQCHLD(1),WQCHLG(1),                    !hnr  10/2010
     * WQCHLM,WQDOPC,WQDOPD,WQDOPG, WQDOPM(1)
      WRITE(2,*) WQKETSS,WQKECHL,WQCHLC(1),WQCHLD(1),WQCHLG(1),                   !hnr 10/2010
     * WQCHLM,WQDOPC,WQDOPD,WQDOPG, WQDOPM(1)
C
...
C
     ...
     *    (WQV(1,1,NW),NW=20,NWQV+1)
        WQCHL(1,1) = WQV(1,1,1)*WQCHLC(1) + WQV(1,1,2)*WQCHLD(1)                      !hnr 10/2010
     *    + WQV(1,1,3)*WQCHLG(1)                                                       !hnr 10/2010
        IF(IWQSRP.EQ.1)THEN
...
c   HNR   2011 add color light extinction with color as dye             !hnr 4/2011
c         here the dye light extinction coefficient is set              !hnr 4/2011
