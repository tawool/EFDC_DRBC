...
!
      ...
      IF(ICON.EQ.5)THEN
        ...
        LUNF=26
        OPEN(LUNF,FILE='RTXPCNH.OUT',POSITION='APPEND',STATUS='UNKNOWN')
      ENDIF
      IF(ICON.EQ.4)THEN
        LUN=17
...
!      SEDBT=1000*SSG*SEDB(L)
       WRITE(LUN,400)CONC(L,KC),CONC(L,1),SEDBTLPF(L,KBT(L))
       ENDDO
      ENDIF
      IF(ICON.EQ.7)THEN
       DO L=2,LA
!      SEDBT=1000*SSG*SNDB(L,KBT(L))
       WRITE(LUN,400)CONC(L,KC),CONC(L,1),SNDBTLPF(L,KBT(L))
       ENDDO
      ENDIF
      IF(ICON.EQ.5)THEN
       DO L=2,LA
       TOXBT=1000.*TOXBLPF(L,KBT(L),1)
       WRITE(LUN,400)CONC(L,KC),CONC(L,1),TOXBT
       ENDDO
       DO L=2,LA
!      SEDBT=1000*SSG*SEDB(L,KBT(L),1)
       WRITE(LUNF,400)TXPFLPF(L,KC,1,1),TXPFLPF(L,1,1,1),TOXBLPF(L,KBT(L),1)
       ENDDO
       CLOSE(LUNF)
      ENDIF
      IF(ICON.EQ.4)THEN
...
!
      ...
      IF(ICON.EQ.6)THEN
       DO L=2,LA
!      SEDBT=1000*SSG*SEDB(L)
       WRITE(LUN,200)IL(L),JL(L),CONC(L,KC),CONC(L,1),SEDBTLPF(L,KBT(L))
       ENDDO
      ENDIF
      IF(ICON.EQ.7)THEN
       DO L=2,LA
!      SEDBT=1000*SSG*SNDB(L,KBT(L))
       WRITE(LUN,200)IL(L),JL(L),CONC(L,KC),CONC(L,1),SNDBTLPF(L,KBT(L))
       ENDDO
      ENDIF
      IF(ICON.EQ.5)THEN
       DO L=2,LA
       TOXBT=1000.*TOXBLPF(L,KBT(L),1)
       WRITE(LUN,200)IL(L),JL(L),CONC(L,KC),CONC(L,1),TOXBT
       ENDDO
       DO L=2,LA
!      SEDBT=1000*SSG*SEDB(L,KBT(L),1)
       WRITE(LUNF,200)IL(L),JL(L),TXPFLPF(L,KC,1,1),TXPFLPF(L,1,1,1),TOXBLPF(L,KBT(L),1)
       ENDDO
       CLOSE(LUNF)
      ENDIF
      IF(ICON.EQ.4)THEN
...
!
      ...
      IF(ICON.EQ.6)THEN
       DO L=2,LA
!      SEDBT=1000*SSG*SEDB(L)
       WRITE(LUN,200)IL(L),JL(L),DLON(L),DLAT(L),CONC(L,KC),CONC(L,1),SEDBTLPF(L,KBT(L))
       ENDDO
      ENDIF
      IF(ICON.EQ.7)THEN
       DO L=2,LA
!      SEDBT=1000*SSG*SNDB(L,KBT(L))
       WRITE(LUN,200)IL(L),JL(L),DLON(L),DLAT(L),CONC(L,KC),CONC(L,1),SNDBTLPF(L,KBT(L))
       ENDDO
      ENDIF
      IF(ICON.EQ.5)THEN
       DO L=2,LA
       TOXBT=1000.*TOXBLPF(L,KBT(L),1)
       WRITE(LUN,200)IL(L),JL(L),DLON(L),DLAT(L),CONC(L,KC),CONC(L,1),TOXBT
       ENDDO
       DO L=2,LA
!      SEDBT=1000*SSG*SEDB(L,KBT(L),1)
       WRITE(LUNF,200)IL(L),JL(L),DLON(L),DLAT(L),TXPFLPF(L,KC,1,1),TXPFLPF(L,1,1,1),TOXBLPF(L,KBT(L),1)
       ENDDO
       CLOSE(LUNF)
      ENDIF
      IF(ICON.EQ.4)THEN
