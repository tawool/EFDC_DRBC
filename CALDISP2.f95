...
!**********************************************************************C
!
      DIMENSION UP(KCM),VP(KCM),CDISP(MGM,MGM),CDISPT(KCM,KCM),CDISPI(KCM,KCM),CCTMP(KCM,KCM),     &
                CCUTMP(KCM),CCVTMP(KCM),CRHS(MGM),CSOL(MGM),WTMP(MGM),VVTMP(MGM,MGM),SVAL(KCM,LCM)
!
!**********************************************************************C
!
      DELT=DT
...
!
  ...
  882 FORMAT(3X,'I',3X,'J',3X,'LON',9X,'LAT',9X,'AMCPT',8X,'AMSPT',8X,'AMCUE',8X,'AMSUE',8X,      &
             'AMCVE',8X,'AMSVE')
  883 FORMAT(3X,'I',3X,'J',3X,'LON',9X,'LAT',9X,'HLPF',9X,'UELPF',8X,'VELPF',8X,'SALLPFBOT',4X,   &
             'SALLPFSURF')
