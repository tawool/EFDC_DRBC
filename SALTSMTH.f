...
!     IF(NSBMAX.GT.10)THEN
!       IF(MOD(NSBMAX,10).EQ.0) GOTO 1000
!      ELSE
!       GOTO 1001
!     ENDIF
!
...
!**********************************************************************C
!
! **  IMPLEMENT SPECIAL SALINITY INITIALIZATION, VERSION 1
!
!**********************************************************************C
!
! 1000 CONTINUE
...
!**********************************************************************C
!
! **  IMPLEMENT SPECIAL SALINITY INITIALIZATION, VERSION 2
!
!**********************************************************************C
!
 1001 CONTINUE
