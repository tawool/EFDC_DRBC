...
!----------------------------------------------------------------------C
!
! **  SUBROUTINE SALPLTV WRITES A FILE FOR VERTICAL PLANE CONTOURING
! **  OF SALINITY, DYE CONCENTRATION, AND SEDIMENT CONCENTRATION 
! **  ALONG AN ARBITARY SEQUENCE OF (I,J) POINTS
!
!**********************************************************************C
!
      INCLUDE 'EFDC.PAR'
...
!
      IF(ITMP.EQ.1.AND.ISTRAN(1).GE.1)THEN
        IF(ISECSPV.GE.1)OPEN(11,FILE='SALCNV1.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.2)OPEN(12,FILE='SALCNV2.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.3)OPEN(13,FILE='SALCNV3.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.4)OPEN(14,FILE='SALCNV4.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.5)OPEN(15,FILE='SALCNV5.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.6)OPEN(16,FILE='SALCNV6.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.7)OPEN(17,FILE='SALCNV7.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.8)OPEN(18,FILE='SALCNV8.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.9)OPEN(19,FILE='SALCNV9.OUT',POSITION='APPEND')
        DO IS=1,ISECSPV
        LUN=10+IS
...
!         HBTMP=HMP(L)
          HBTMP=BELV(L)
!        HBTMP=SHPLTV*HMP(L)+SBPLTV(ITMP)*BELV(L)
...
!
      IF(ITMP.EQ.2.AND.ISTRAN(2).GE.1)THEN
        IF(ISECSPV.GE.1)OPEN(21,FILE='TEMCNV1.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.2)OPEN(22,FILE='TEMCNV2.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.3)OPEN(23,FILE='TEMCNV3.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.4)OPEN(24,FILE='TEMCNV4.OUT',POSITION='APPEND')
         IF(ISECSPV.GE.5)OPEN(25,FILE='TEMCNV5.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.6)OPEN(26,FILE='TEMCNV6.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.7)OPEN(27,FILE='TEMCNV7.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.8)OPEN(28,FILE='TEMCNV8.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.9)OPEN(29,FILE='TEMCNV9.OUT',POSITION='APPEND')
        DO IS=1,ISECSPV
        LUN=20+IS
        WRITE (LUN,100)N,TIME
         DO NN=1,NIJSPV(IS)
...
!
      IF(ITMP.EQ.3.AND.ISTRAN(3).GE.1)THEN
        IF(ISECSPV.GE.1)OPEN(31,FILE='DYECNV1.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.2)OPEN(32,FILE='DYECNV2.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.3)OPEN(33,FILE='DYECNV3.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.4)OPEN(34,FILE='DYECNV4.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.5)OPEN(35,FILE='DYECNV5.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.6)OPEN(36,FILE='DYECNV6.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.7)OPEN(37,FILE='DYECNV7.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.8)OPEN(38,FILE='DYECNV8.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.9)OPEN(39,FILE='DYECNV9.OUT',POSITION='APPEND')
        DO IS=1,ISECSPV
        LUN=30+IS
        WRITE (LUN,100)N,TIME
         DO NN=1,NIJSPV(IS)
...
!
      IF(ITMP.EQ.6.AND.ISTRAN(6).GE.1)THEN
        IF(ISECSPV.GE.1)OPEN(41,FILE='SEDCNV1.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.2)OPEN(42,FILE='SEDCNV2.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.3)OPEN(43,FILE='SEDCNV3.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.4)OPEN(44,FILE='SEDCNV4.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.5)OPEN(45,FILE='SEDCNV5.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.6)OPEN(46,FILE='SEDCNV6.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.7)OPEN(47,FILE='SEDCNV7.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.8)OPEN(48,FILE='SEDCNV8.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.9)OPEN(49,FILE='SEDCNV9.OUT',POSITION='APPEND')
        DO IS=1,ISECSPV
        LUN=40+IS
        WRITE (LUN,100)N,TIME
         DO NN=1,NIJSPV(IS)
...
!
      IF(ITMP.EQ.7.AND.ISTRAN(7).GE.1)THEN
        IF(ISECSPV.GE.1)OPEN(51,FILE='SNDCNV1.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.2)OPEN(52,FILE='SNDCNV2.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.3)OPEN(53,FILE='SNDCNV3.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.4)OPEN(54,FILE='SNDCNV4.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.5)OPEN(55,FILE='SNDCNV5.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.6)OPEN(56,FILE='SNDCNV6.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.7)OPEN(57,FILE='SNDCNV7.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.8)OPEN(58,FILE='SNDCNV8.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.9)OPEN(59,FILE='SNDCNV9.OUT',POSITION='APPEND')
        DO IS=1,ISECSPV
        LUN=50+IS
        WRITE (LUN,100)N,TIME
         DO NN=1,NIJSPV(IS)
...
!
      IF(ITMP.EQ.5.AND.ISTRAN(5).GE.1)THEN
        IF(ISECSPV.GE.1)OPEN(61,FILE='TOXCNV1.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.2)OPEN(62,FILE='TOXCNV2.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.3)OPEN(63,FILE='TOXCNV3.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.4)OPEN(64,FILE='TOXCNV4.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.5)OPEN(65,FILE='TOXCNV5.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.6)OPEN(66,FILE='TOXCNV6.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.7)OPEN(67,FILE='TOXCNV7.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.8)OPEN(68,FILE='TOXCNV8.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.9)OPEN(69,FILE='TOXCNV9.OUT',POSITION='APPEND')
        DO IS=1,ISECSPV
        LUN=60+IS
        WRITE (LUN,100)N,TIME
         DO NN=1,NIJSPV(IS)
...
!
      IF(ITMP.EQ.4.AND.ISTRAN(4).GE.1)THEN
        IF(ISECSPV.GE.1)OPEN(71,FILE='SFLCNV1.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.2)OPEN(72,FILE='SFLCNV2.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.3)OPEN(73,FILE='SFLCNV3.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.4)OPEN(74,FILE='SFLCNV4.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.5)OPEN(75,FILE='SFLCNV5.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.6)OPEN(76,FILE='SFLCNV6.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.7)OPEN(77,FILE='SFLCNV7.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.8)OPEN(78,FILE='SFLCNV8.OUT',POSITION='APPEND')
        IF(ISECSPV.GE.9)OPEN(79,FILE='SFLCNV9.OUT',POSITION='APPEND')
        DO IS=1,ISECSPV
        LUN=70+IS
        WRITE (LUN,100)N,TIME
         DO NN=1,NIJSPV(IS)
