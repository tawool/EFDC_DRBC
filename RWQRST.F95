...
!**********************************************************************C
!
! READ ICS FROM RESTART FILE FROM INWQRST.
!
!**********************************************************************C
!
      INCLUDE 'EFDC.PAR'
...
!        OPEN(UNIT=1, FILE='WQWCRST.BIN', ACCESS='TRANSPARENT',
        OPEN(UNIT=1, FILE='WQWCRST.BIN',FORM='UNFORMATTED', STATUS='UNKNOWN')
        READ(1) NN, XTIME
        XTIME=XTIME
